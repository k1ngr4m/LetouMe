...
vi.mock('./hooks/useHomeData', () => ({
  useHomeData: (lotteryCode: string = 'dlt') => {
    if (lotteryCode === 'pl3') {
      return {
        currentPredictions: {
          data: {
            ...
            models: [
              {
                ...
                score_profile: {
                  ...
                  recent_score: 93,
                  long_term_score: 88,
                  component_scores: { profit: 92, hit_rate: 90, stability: 87, ceiling: 95, floor: 82 },
                },
                predictions: [{ group_id: 1, play_type: 'direct_sum', sum_value: '10', red_balls: [], blue_balls: [], digits: [] }],
              },
              {
                model_id: 'model-a',
                model_name: '模型A',
                ...
                score_profile: {
                  ...
                  recent_score: 35,
                  long_term_score: 29,
                  component_scores: { profit: 30, hit_rate: 32, stability: 31, ceiling: 36, floor: 22 },
                },
                predictions: [{ group_id: 1, play_type: 'direct', red_balls: [], blue_balls: [], digits: ['01', '02', '03'] }],
              },
            ],
          },
          isLoading: false,
            ...
            model_stats: [
              {
                ...
                score_profile: {
                  ...
                  recent_score: 93,
                  long_term_score: 90,
                  component_scores: { profit: 96, hit_rate: 95, stability: 88, ceiling: 97, floor: 86 },
                },
              },
              {
                model_id: 'model-a',
                ...
                score_profile: {
                  ...
                  recent_score: 31,
                  long_term_score: 36,
                  component_scores: { profit: 30, hit_rate: 32, stability: 35, ceiling: 37, floor: 24 },
                },
              },
            ],
            predictions_history: [],
...
function renderPage(initialPath = '/dashboard/models/model-a', state: Record<string, unknown> = { scrollY: 320 }) {
...
describe('HomeModelDetailPage', () => {
  it('renders the standalone model detail page', async () => {
    ...
    expect(screen.queryByText('能力上限')).not.toBeInTheDocument()
    expect(screen.queryByText('能力下限')).not.toBeInTheDocument()
