    ...
    def test_build_number_rows_serializes_supported_fields(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                ("direct_hundreds_dan", 1, "01"),
                ("direct_hundreds_tuo", 1, "02"),
                ("direct_hundreds_tuo", 2, "03"),
                ("group", 1, "07"),
                ("group", 2, "08"),
                ("sum", 1, "10"),
                ("sum", 2, "11"),
    ...
    def test_merge_number_rows_rebuilds_legacy_fields(self) -> None:
        payload = merge_number_rows(
            [
                ...
                {"number_role": "direct_units_dan", "number_position": 1, "number_value": "08"},
            ]
        )
        ...
        self.assertEqual(payload["direct_units_dan"], "08")
